...
export const MISSIONS = [
  ...
  },
  {
    ...
    blurb: "A passphrase-encrypted payload holding a whole wallet: 3 codex32 seed shares, 6 key cards, 6 policy cards.",
    taps: null, wrapper: null, measured: false, advanced: true,
    ...
    steps: [
      'At <b>"A systemwide payload is present. Load it?"</b> tap <b>SKIP</b>, then <kbd>confirm</kbd>.',
      'Tap <kbd>previous</kbd> <b>once</b>. <b>Sealed Payload</b> is the last entry, so backwards reaches it immediately.',
      'Tap <kbd>confirm</kbd> and enter the passphrase shown under the device on this page.',
      'Explore what it holds. Everything in it is a published throwaway test vector.',
    ],
    ends: "The sealed container's contents, as plates.",
    note: "Tap count not yet measured — unlike the three above, nobody has driven this one end to end, so treat the steps as a sketch.",
  },
];
