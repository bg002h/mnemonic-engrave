...
# ms -- the seed tool
curl -LO https://github.com/bg002h/mnemonic-secret/releases/download/ms-cli-v0.20.0/ms-0.20.0-macos-amd64.tar.gz

tar -xzf md-0.20.3-macos-amd64.tar.gz
tar -xzf ms-0.20.0-macos-amd64.tar.gz
...
```sh
curl -LO https://github.com/bg002h/mnemonic-secret/releases/download/ms-cli-v0.20.0/SHA256SUMS.portable
