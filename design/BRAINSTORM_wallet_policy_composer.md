...
6. **Recon items:** (1) taproot multisig origin convention and (2) coordinator
   import of same-fingerprint two-account cosigners — DISPATCHED (C27);
   (3) unhardened-child route — DEFERRED by the operator.
