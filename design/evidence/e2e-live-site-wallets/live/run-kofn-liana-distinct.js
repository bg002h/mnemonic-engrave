...
out.seat = [];
const SEATS = [1,2,3,1], TYPED = {2:"legal winner thank year wave sausage worth useful legal winner thank yellow",3:"letter advice cage absurd amount doctor acoustic avoid letter advice cage above"}; let nSeeds = 1;
