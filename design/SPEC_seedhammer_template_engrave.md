...
- **Status:** DRAFT v3.1 — md-codec readiness folded (v2) + R0 round 0 folded (3C/5I) + **R0 round 1 folded (0C/1I: D1 supply-path drift; see Gate)**. Awaiting R0 round 2 (must reach 0C/0I before any plan/code).
