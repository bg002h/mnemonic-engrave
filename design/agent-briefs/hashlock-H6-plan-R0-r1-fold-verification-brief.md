...
1. Per C/I finding: the diff `git diff <PLAN_SHA>..<FOLD_SHA> -- design/IMPLEMENTATION_PLAN_hashlock_H6_preimage_plates.md design/SPEC_hashlock_H6_preimage_plates.md`, and whether it fixes the defect as stated.
