...
- Branch `composer-s4c` (worktree `/scratch/code/shibboleth/wt-composer-s4c`), tip `0b49f66c16aae1a055b8403a24b242acd3548710`, base `main` = `3cc71d9b`. Verify in the main checkout: `git rev-parse main` = 3cc71d9b..., `git status --short` empty, `git merge-base --is-ancestor main composer-s4c` true; STOP if not.
