...
- Branch `composer-s4-emu` (worktree `/scratch/code/shibboleth/wt-composer-s4-emu`), tip `b481be7121f6b7201f09f398b97e8b8d3b672a0d`, base `main` = `1ae0ffcb`. Verify in the main checkout: `git rev-parse main` = 1ae0ffcb..., `git status --short` empty, `git merge-base --is-ancestor main composer-s4-emu` true; STOP if not.
