...
- **Fork diff** (Tasks 1, 3): `CGO_ENABLED=0 go test -count=1 ./cmd/emu/`;
  ...
  the size recipe must read `1,580,580 B flash / 62,800 B RAM` at the merge --
  that is fork `main` `3cc71d9b` after W-2 (+640 B flash over `60bee002`'s
  1,579,940, measured three times: implementer, verifier, controller); Tasks 1-3
  add nothing, and a different number is a finding.
