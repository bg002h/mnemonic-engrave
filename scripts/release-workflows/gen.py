...
def gen(*, bin_, pkg, branch, names, why_subset, smoke, test_setup="", test_os="[ubuntu-latest]", features=""):
    matrix = "".join(
        f"""          - name: {n}
            os: {TARGETS[n][0]}
            target: {TARGETS[n][1]}
